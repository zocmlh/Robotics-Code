...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    Spark frontLeft = new Spark(RobotMap.leftFrontMotor);
    Spark rearLeft = new Spark(RobotMap.leftRearMotor);
    ...
    Spark frontRight = new Spark(RobotMap.rightFrontMotor);
    Spark rearRight = new Spark(RobotMap.rightRearMotor);
  ...
  public void teleopInit() {
    ...
    //Shooting System
    Spark Shooty = new Spark(RobotMap.Shooter);
      if(m_stickl.getRawButton(1)){
        Shooty.set(2)
      }
      else{
        Shooty.set(0)
    ...
    //Wheel
    Spark Acuator = new Spark(RobotMap.Acuator); //Acuator Up
      if(m_stickl.getRawButton(3)){
        Acuator.set(1)
      }
      else if(m_stickl.getRawButton(2)){
        Acuator.set(-1);
      }
      else{
        Acuator.set(0)
      }
    Spark Wheel = New Spark(RobotMap.Wheel); //Wheel
      if(m_stickr.getRawButton(1)){
        Wheel.set(2);
      }
      else{
        Wheel.set(0);
